...
with_node \
  ...
  --target "/Users/barmor/Desktop/fullstack_project/FullStack_Project_Frontend/ios/Pods/Target Support Files/Pods-scefrontend/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-web-browser"
